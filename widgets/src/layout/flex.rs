...
mod tests {
  ...
  fn horizontal_line() -> impl FnWidget {
    fn_widget! {
      @Flex {
        @{
  ...
  fn vertical_line() -> impl FnWidget {
    fn_widget! {
      @Flex {
  ...
  fn reverse_row_wrap() -> impl FnWidget {
    let size = Size::new(200., 20.);
    fn_widget! {
      @Flex {
        wrap: true,
  ...
  fn main_axis_gap() -> impl FnWidget {
    fn_widget! {
      @Row {
        item_gap: 15.,
  ...
  fn main_axis_reverse_gap() -> impl FnWidget {
    fn_widget! {
      @Row {
        item_gap: 15.,
        reverse: true,
  ...
  fn main_axis_expand() -> impl FnWidget {
    fn_widget! {
      @Row {
        item_gap: 15.,
        @SizedBox { size: Size::new(120., 20.) }
  ...
  fn cross_axis_gap() -> impl FnWidget {
    let size = Size::new(200., 20.);
    fn_widget! {
      @Flex {
        wrap: true,
  ...
  fn cross_align(align: Align) -> impl FnWidget {
    fn_widget! {
      @Row {
        align_items: align,
  ...
  fn start_cross_align() -> impl FnWidget { cross_align(Align::Start) }
  widget_layout_test!(
    start_cross_align,
  ...
  fn center_cross_align() -> impl FnWidget { cross_align(Align::Center) }
  widget_layout_test!(
    center_cross_align,
    { path =[0],  width == 300., height == 40., }
  ...
  fn end_cross_align() -> impl FnWidget { cross_align(Align::End) }
  widget_layout_test!(
    end_cross_align,
    { path =[0],  width == 300., height == 40., }
  ...
  fn stretch_cross_align() -> impl FnWidget { cross_align(Align::Stretch) }
  widget_layout_test!(
    stretch_cross_align,
    wnd_size = Size::new(500., 40.),
    { path =[0],  width == 300., height == 40., }
  ...
  fn main_align(justify_content: JustifyContent) -> impl FnWidget {
  ...
  fn start_main_align() -> impl FnWidget { main_align(JustifyContent::Start) }
  widget_layout_test!(
    start_main_align,
    wnd_size = Size::new(500., 500.),
  ...
  fn center_main_align() -> impl FnWidget { main_align(JustifyContent::Center) }
  widget_layout_test!(
    center_main_align,
    wnd_size = Size::new(500., 500.),
    { path =[0, 0], width == 500., height == 500.,}
  ...
  fn end_main_align() -> impl FnWidget { main_align(JustifyContent::End) }
  widget_layout_test!(
    end_main_align,
    wnd_size = Size::new(500., 500.),
    { path =[0, 0], width == 500., height == 500.,}
  ...
  fn space_between_align() -> impl FnWidget { main_align(JustifyContent::SpaceBetween) }
  widget_layout_test!(
    space_between_align,
    wnd_size = Size::new(500., 500.),
    { path =[0, 0], width == 500., height == 500.,}
  ...
  fn space_around_align() -> impl FnWidget { main_align(JustifyContent::SpaceAround) }
  ...
  fn space_evenly_align() -> impl FnWidget { main_align(JustifyContent::SpaceEvenly) }
  widget_layout_test!(
    space_evenly_align,
    wnd_size = Size::new(500., 500.),
    { path =[0, 0], width == 500., height == 500.,}
