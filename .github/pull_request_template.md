...
<details>
<summary>💡 PR Bot Commands</summary>

You can control the bot via comments:

```
@pr-bot regenerate [context]  # Regenerate summary and changelog
@pr-bot summary [context]     # Regenerate only the summary
@pr-bot changelog [context]   # Regenerate only the changelog
@pr-bot help                  # Show all available commands
```
