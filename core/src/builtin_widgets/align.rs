...
mod tests {
  ...
  fn h_align(h_align: HAlign) -> impl FnWidget {
    fn_widget! {
      @HAlignWidget {
        h_align,
  ...
  fn left_align() -> impl FnWidget { h_align(HAlign::Left) }
  widget_layout_test!(
    left_align,
    wnd_size = WND_SIZE,
  ...
  fn h_center_align() -> impl FnWidget { h_align(HAlign::Center) }
  widget_layout_test!(
    h_center_align,
    wnd_size = WND_SIZE,
    { path = [0], width == 100., height == 10.,}
  ...
  fn right_align() -> impl FnWidget { h_align(HAlign::Right) }
  widget_layout_test!(
    right_align,
    wnd_size = WND_SIZE,
    { path = [0], width == 100., height == 10.,}
  ...
  fn h_stretch_algin() -> impl FnWidget { h_align(HAlign::Stretch) }
  widget_layout_test!(
    h_stretch_algin,
    wnd_size = WND_SIZE,
    { path = [0], width == 100., height == 10.,}
  ...
  fn v_align(v_align: VAlign) -> impl FnWidget {
    fn_widget! {
      @VAlignWidget {
        v_align,
        @MockBox { size: CHILD_SIZE }
  ...
  fn top_align() -> impl FnWidget { v_align(VAlign::Top) }
  widget_layout_test!(
    top_align,
    wnd_size = WND_SIZE,
  ...
  fn v_center_align() -> impl FnWidget { v_align(VAlign::Center) }
  widget_layout_test!(
    v_center_align,
    wnd_size = WND_SIZE,
    { path = [0], width == 10., height == 100.,}
  ...
  fn bottom_align() -> impl FnWidget { v_align(VAlign::Bottom) }
  widget_layout_test!(
    bottom_align,
    wnd_size = WND_SIZE,
    { path = [0], width == 10., height == 100.,}
  ...
  fn v_stretch_align() -> impl FnWidget { v_align(VAlign::Stretch) }
  widget_layout_test!(
    v_stretch_align,
    wnd_size = WND_SIZE,
    { path = [0], width == 10., height == 100.,}
