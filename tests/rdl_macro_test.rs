...
fn simplest_leaf_rdl() -> impl FnWidget {
  fn_widget! {
...
fn with_child_rdl() -> impl FnWidget {
  fn_widget! {
    rdl!{
      Row {
        rdl!{ SizedBox { size: Size::new(500.,500.)  } }
...
fn with_builtin_child_rdl() -> impl FnWidget {
  fn_widget! {
    rdl!{ SizedBox {
...
fn rdl_with_child() -> impl FnWidget {
  fn_widget! {
...
fn single_rdl_has_builtin_with_child() -> impl FnWidget {
  fn_widget! {
...
fn multi_child_rdl_has_builtin_with_child() -> impl FnWidget {
  fn_widget! {
...
fn compose_child_rdl_has_builtin_with_child() -> impl FnWidget {
  fn_widget! {
...
fn access_rdl_widget() -> impl FnWidget {
  fn_widget! {
...
fn access_builtin_rdl_widget() -> impl FnWidget {
  fn_widget! {
...
fn dollar_as_rdl_parent() -> impl FnWidget {
  fn_widget! {
    let b = rdl!{SizedBox { size: Size::new(500.,500.) }};
    rdl!{ $b { rdl!{ Void {}} } }
  }
...
fn dollar_as_middle_parent() -> impl FnWidget {
  fn_widget! {
    let b = rdl!{ SizedBox { size: Size::new(500.,500.) }};
...
fn pipe_as_field_value() -> impl FnWidget {
...
fn pipe_as_builtin_field_value() -> impl FnWidget {
...
fn pipe_with_ctx() -> impl FnWidget {
...
fn pipe_with_builtin_field() -> impl FnWidget {
  fn_widget! {
...
fn capture_closure_used_ctx() -> impl FnWidget {
  fn_widget! {
...
fn at_in_widget_macro() -> impl FnWidget {
  fn_widget! {
...
fn at_as_variable_in_widget() -> impl FnWidget {
  fn_widget! {
...
fn at_as_variable_in_rdl() -> impl FnWidget {
  fn_widget! {
    let size = Size::new(100., 100.);
    let row = @Row {};
    rdl!{
...
fn access_builtin_field_by_dollar() -> impl FnWidget {
  fn_widget! {
    let size = Size::new(100., 100.);
...
fn at_embed_in_expression() -> impl FnWidget {
  fn_widget! {
    @Row {
      @{ (0..3).map(|_| {
        @SizedBox { size: Size::new(100., 100.) }
...
fn local_var_not_bind() -> impl FnWidget {
...
fn fix_local_assign_tuple() -> impl FnWidget {
  fn_widget! {
